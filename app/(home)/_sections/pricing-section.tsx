        ...
        <section className="relative -mt-20 w-full mx-auto z-30">
            <div className="max-w-[1440px] px-4 py-10 grid gap-6 md:grid-cols-2">
                <Card className="overflow-hidden relative">
                    <CardContent className="relative z-30 flex items-center space-x-4 p-6">
                        <Image
                            priority={true}
                            src="/logo.png"
                            alt="@logo"
                        ...
                        <div className="flex flex-col justify-start items-start bg-white px-4 py-2 rounded-md">
                            <h3 className="text-2xl font-bold text-[#f26f25]">CƠM TỰ CHỌN</h3>
                            <span className="p-0 m-0">(tặng kèm trè hoa quả tráng miêng)</span>
                    ...
                    <div className="absolute top-4 -right-36 bg-[#ec2028] text-white text-sm font-bold py-1 px-40 transform rotate-45 z-40">
                        SALE
                    </div>
                    <Image
                        priority={true}
                ...
                <Card className="relative overflow-hidden">
                    <CardContent className="relative w-full h-full flex items-center justify-between p-6 z-30">
                        <div className="flex flex-col justify-start items-start bg-white px-4 py-2 rounded-md">
                            ...
                            <p className="text-4xl font-bold text-[#f26f25]">
                                GIẢM
                                <span className="ml-2 text-base md:text-lg font-semibold text-[#ec2028]">10%</span>
                            </p>
                        </div>
                    </CardContent>
                    <div className="absolute top-4 -right-36 bg-[#ec2028] text-white text-sm font-bold py-1 px-40 transform rotate-45 z-40">
